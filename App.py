...
setting_bg()
df1=pd.read_csv(r"C:\Users\91822\OneDrive\Documents\Capstone6\combined.csv")
df=pd.read_csv(r'C:\Users\91822\OneDrive\Documents\Capstone6\Proceesed_data.csv')
...
with tab2:  
    ...
    if st.button('Predict Price'):
        ...
        def load_data():
            # Load data
            data = pd.read_csv(r'C:\Users\91822\OneDrive\Documents\Capstone6\Proceesed_data.csv')
        ...
        st.write('# :blue[Predicted Resale price:]', f"${predicted_price}")
